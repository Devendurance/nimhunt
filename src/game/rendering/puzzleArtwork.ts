...
/** Development fallback procedural textures. Kept for resilience if production assets fail to load. */
export const DEV_FALLBACK_TEXTURES = {
  boulder: 'dev_puzzle_boulder',
  key: 'dev_temple_key',
  gate: 'dev_temple_gate',
  shrine: 'dev_inner_shrine',
} as const

/** Backward-compatibility alias for tests */
export const PUZZLE_TEXTURES = DEV_FALLBACK_TEXTURES

export function createDevFallbackArtwork(scene: Phaser.Scene): void {
  ...
  save(DEV_FALLBACK_TEXTURES.boulder)
  ...
  save(DEV_FALLBACK_TEXTURES.key)
  ...
  save(DEV_FALLBACK_TEXTURES.gate)
  ...
  save(DEV_FALLBACK_TEXTURES.shrine)
  draw.destroy()
}

/** Backward-compatibility alias for tests */
export const createPuzzleArtwork = createDevFallbackArtwork
